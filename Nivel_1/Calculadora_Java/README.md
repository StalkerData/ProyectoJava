...
Forma parte del **Nivel 1** del portafolio, enfocado en bases sólidas antes de avanzar a frameworks o persistencia de datos.
...
- Manejar entrada de datos por consola.
...
2. Permitir seleccionar una operación matemática:
   ...
   - División
   - Módulo
3. Solicitar dos valores numéricos.
4. Validar las entradas del usuario.
5. Realizar el cálculo seleccionado.
6. Mostrar el resultado en consola.
7. Repetir el proceso hasta que el usuario decida salir.
