...
Este proyecto forma parte del **Nivel 1** del portafolio y está enfocado en lógica backend, manejo de colecciones y validaciones básicas.
...
- Simular un sistema real en un entorno de consola.
...
4. Permitir que cada estudiante tenga una cantidad variable de notas.
5. Calcular el promedio de notas de un estudiante.
6. Listar todos los estudiantes registrados.
7. Consultar la información de un estudiante por su identificador.
8. Validar estados como:
   - Lista de estudiantes vacía
   - Estudiante inexistente
   - Estudiante sin notas registradas
9. Finalizar el programa de forma controlada.
